    ...
    <div>
      <div className="mb-5 flex items-start justify-between gap-3">
        ...
        <div className="flex gap-2">
          <button className="icon-button" type="button" aria-label="Play from here" title="Play from here" onClick={() => onPlayFromHere(node.id)}>
            <Play size={18} />
          </button>
          <button className="icon-button" type="button" aria-label="Duplicate node" title="Duplicate node" onClick={onDuplicateNode}>
            <Copy size={18} />
          </button>
          <button className="icon-button" type="button" aria-label="Delete node" title="Delete node" onClick={onDeleteNode}>
            <Trash2 size={18} />
          </button>
        </div>
      </div>
